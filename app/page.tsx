    ...
    <div className="flex min-h-screen flex-col">
      <nav className="border-b border-gray-800 bg-gray-900/50">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
          ...
          <div className="flex gap-3">
            <Link href="/login" className="rounded border border-gray-700 px-4 py-2 text-sm hover:bg-gray-800">
              Sign in
            </Link>
            <Link href="/register" className="rounded bg-blue-600 px-4 py-2 text-sm font-medium hover:bg-blue-700">
              Get started
            </Link>
          </div>
        </div>
      ...
      <main className="flex flex-1 flex-col items-center justify-center px-4 text-center">
        ...
        <div className="mt-8 flex gap-4">
          <Link href="/register" className="rounded bg-blue-600 px-6 py-3 font-medium hover:bg-blue-700">
            Start building
          </Link>
          <Link href="/login" className="rounded border border-gray-700 px-6 py-3 font-medium hover:bg-gray-800">
            Sign in
          </Link>
        </div>

        <div className="mt-16 grid max-w-3xl gap-6 text-left sm:grid-cols-3">
          <div className="rounded border border-gray-800 bg-gray-900/30 p-5">
